...
Initial server state prior to the mac enrollment, alerts that are shown are from the server self-monitoring
...
- File Integrity Monitoring: Learning how to understand checksums, baselines, and how changes within activity or files affect these.
